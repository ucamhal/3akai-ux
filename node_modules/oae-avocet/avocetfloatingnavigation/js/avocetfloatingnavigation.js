 ...
 */
 ...
 define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid) {
        ...
        var $navigationWrapper = $('.avocetfloatingnavigation-wrapper', $rootel);

        var scrollElementSelector = $rootel.data('scroll-element');
        var $scrollElement = $(scrollElementSelector);
        ...
        var renderNavigation = function() {
            oae.api.util.template().render($navTemplate, {
                'navs': navEntries,
                'navTitle': navTitle
            }, $navigationWrapper);
        };
        ...
        // If we initialise immediately the page isn't visible so scrollspy
