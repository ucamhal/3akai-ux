    ...
    return function(uid) {
        ...
        var renderTermsAndConditions = function() {
            oae.api.user.getTC(function(err, data) {
                ...
                oae.api.util.template().render($('#oa-modal-terms-body-template', $rootel), {
                    'terms': data.text
                }, $('#oa-modal-terms-body-container', $rootel));
            });
        };
        ...
        var addBinding = function() {
            $(document).on('click', '.oa-trigger-terms', showModal);
        };
