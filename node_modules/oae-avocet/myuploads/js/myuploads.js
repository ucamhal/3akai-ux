            ...
            infinityScroll = $('#oa-myuploads-container', $rootel).infiniteScroll(url, {
                ...
                postProcessor: function(data) {
                    ...
                    _.each(data.results, function(publication) {
                        ...
                        // Add an authorNames field to each publication containing the actual names of each author, regardless of whether they're an OAE user or not.
                        publication.authorNames = _.map(publication.authors, function(author) {
