...
define(['jquery', 'oae.core', 'jquery.fileupload', 'jquery.iframe-transport'], function($, oae) {
    ...
    return function(uid) {
        ...
        /**
         * Initialises the fileupload functionlity of the widget
         */
        ...
        /**
         * Inserts and initialises the publicationform widget
         */
        var initForm = function() {
            ...
            $(document).on('oa.publicationform.submit', function(event, data) {
                showPanels($progress);
                oae.api.publication.createPublication(data.title, data.author, data.department, data.journal, data.funders, data.email, data['use-cambridge-addendum'] === 'on', data.comment, $upload, selectedFile, function(error, data) {
