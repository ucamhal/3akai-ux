...
define(['jquery', 'oae.core', 'jquery.fileupload', 'jquery.iframe-transport'], function($, oae) {
    ...
    return function(uid) {
        ...
        var $versionCollapseTarget = $('#oa-submitpublication-welcome-help', $rootel);
        var $versionCollapseIcon = $('button[data-target="#oa-submitpublication-welcome-help"] [class*=icon-]', $rootel);
        ...
        // constants for flipExpandCollapseChevron()
        var COLLAPSE_OPEN_CLASS = 'icon-chevron-down';
        var COLLAPSE_CLOSE_CLASS = 'icon-chevron-up';
        var COLLAPSE_CLASSES = COLLAPSE_OPEN_CLASS + ' ' + COLLAPSE_CLOSE_CLASS;

        /**
         * Flip an up/down arrow icon when a Bootstrap collapsable area expands/collapses.
         *
         * @param  {jQuery}  $collapseTarget  The element to watch for expand/collapse on
         * @param  {jQuery}  $iconElems       The icon element(s) to flip the arrow icon of when the target is collapsed/expanded
         */
        var flipExpandCollapseChevron = function($collapseTarget, $iconElems) {
            $collapseTarget.on('show.bs.collapse hide.bs.collapse', function(e) {
                $iconElems.removeClass(COLLAPSE_CLASSES);
                var iconClass = COLLAPSE_OPEN_CLASS;
                if (e.type === 'show') {
                    iconClass = COLLAPSE_CLOSE_CLASS;
                }
                $iconElems.addClass(iconClass);
            });
        };
        ...
        // Keep the expand/collapse arrow pointing in the right direction
        flipExpandCollapseChevron($versionCollapseTarget, $versionCollapseIcon);
    };
});
