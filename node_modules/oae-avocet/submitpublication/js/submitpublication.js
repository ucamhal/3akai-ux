    ...
    return function(uid) {
        ...
        var initForm = function() {
            ...
            $(document).on('oa.publicationform.submit', function(event, data) {
                showPanels($progress);
                oae.api.publication.createPublication(data.title, data.authors, data.department, data.journal, data.acceptanceDate, data.funders, data.email, data['use-cambridge-addendum'] === 'on', data.comment, $upload, selectedFile, function(error, data) {
