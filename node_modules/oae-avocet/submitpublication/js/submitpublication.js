        ...
        var initFileupload = function() {
            $upload.fileupload({
                'add': function(event, data) {
                    ...
                    //$upload.hide();
                    //$form.show();
                    oae.api.publication.createPublication(selectedFile.name, 'Nicolaas Matthijs', 'Physics', 'WelcomeTrust', oae.data.me.email, 'bla', 'bla', $upload, selectedFile, function(err) {
                        alert(err);
                    })
                },
