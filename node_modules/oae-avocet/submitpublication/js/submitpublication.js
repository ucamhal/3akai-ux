    ...
    return function(uid) {
        ...
        var initForm = function() {
            ...
            $(document).on('oa.publicationform.submit', function(event, data) {
                ...
                oae.api.tickets.createTicket(data.title, data.authors, data.department, data.institution, data.journal, data.acceptanceDate, data.funders, data.email, data.useCambridgeAddendum, data.comment, createdContent.id, function(error, data) {
