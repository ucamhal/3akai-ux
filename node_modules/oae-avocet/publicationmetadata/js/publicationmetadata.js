    ...
    return function(uid, showSettings, widgetData) {
        ...
        var fields = {
            ...
            'accepted': ['Accepted', 'ok', function(publication) {
                return !publication.acceptanceDate ? 'Not specified' : oae.api.util.utcDateToLocal(publication.acceptanceDate);
            }],
        ...
        var getFieldsForUserRole = function(role) {
            return _.reduce(addedFieldsPerUserRoles, function(selectedFields, fieldsForUserRole) {
                ...
                // Roles have the fields directly attached to them as well as the fields of all roles following them.
