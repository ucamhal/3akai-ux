    ...
    return function(uid, showSettings, widgetData) {
        ...
        var formDataToPublicationData = function(data) {
            return {
                ...
                'funders': data.hasExternalFunders === 'no' ? [] : (function() {
                    // Ensure funders is an array
                    var funders = [].concat(data.funders);
                    // Find the index of the 'other' checkbox in the funders array
                    var otherIndex = funders.indexOf('other');
                    if (otherIndex >= 0) {
                        // Remove the 'other' checkbox from the funders array
                        funders.splice(otherIndex, 1);
                ...
                'useCambridgeAddendum': String(data['useCambridgeAddendum'] === 'yes'),
        ...
        var trackModals = function() {
            $rootel.on('click', '[data-toggle="modal"]', function(ev) {
                ...
                oae.api.analytics.trackModalOpen(name, ev.target);
            });
        };
