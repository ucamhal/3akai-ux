...
define(['jquery', 'underscore', 'oae.core', 'jquery.typeahead', 'bootstrap.datepicker', 'globalize'], function($, _, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var renderForm = function(data) {
            oae.api.util.template().render($('#oa-publicationform-form-template'), data, $('#oa-publicationform-form-container'));
        };
        ...
        var bindEvents = function() {
            ...
            $rootel.on('change', '[name="hasExternalFunders"]', function() {
                var $fundersContainer = $('#oa-publicationform-funders-container', $rootel);
            ...
            if (!widgetData || !widgetData.disabled) {
                // Revalidate the funders form section when the 'other funder' input
                // value changes, or when the user has changed whether or not this
                // publication has recevied external funding at all. This custom
                // validation is required because these form elements aren't
                // considered part of the funders field by default which is why
                // their validation isn't automatically triggered.
        ...
        var initForm = function() {
            ...
            renderForm(getMinimumFormTemplateData(widgetData));
            ...
            // Clear the comments textarea if it's empty to avoid placeholder bug
            // @see https://github.com/CUL-DigitalServices/avocet-ui/issues/66
            var $commentsArea = $('#oa-publicationform-input-comments', $rootel);
            if ($commentsArea.val() === '') {
            ...
            if (!widgetData || !widgetData.disabled) {
                ...
                $('.input-group.date input', $rootel).on('keyup keydown', function(e) {
                    if (e.keyCode === 13) {
