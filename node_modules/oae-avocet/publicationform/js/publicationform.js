...
define(['jquery', 'underscore', 'oae.core', 'jquery.typeahead', 'bootstrap.datepicker'], function($, _, oae) {
        ...
        var initFormValidation = function() {
            ...
            $.validator.addMethod('oa-validate-date', function (value, element) {
                ...
                if (re.test(value)) {
                    ...
                    // Check whether the date exists (e.g. not 32/01/2013)
            ...
            oae.api.util.validation().validate($('form', $rootel), {
                ...
                'errorPlacement': function($error, $element) {
                    ...
                    // If the inputs parent is a '.input-group' insert the error after the input group otherwise insert it directly after the input element.
                ...
                'submitHandler': function(form) {
                    ...
                    var acceptanceDatePieces = data['acceptanceDate'].split(/\//g);
                    var year = acceptanceDatePieces[2];
                    var month = acceptanceDatePieces[1];
                    var day = acceptanceDatePieces[0];
                    data['acceptanceDate'] = (new Date(year, month - 1, day)).valueOf();
