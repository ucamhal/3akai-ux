...
define(['jquery', 'underscore', 'oae.core', 'jquery.typeahead', 'bootstrap.datepicker', 'globalize'], function($, _, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        /**
         * Check whether or not the author is from University of Cambridge
         *
        ...
        var resetForm = function() {
            ...
            $('.input-group.date .oa-publicationform-trigger-datepicker', $rootel).off();
            $('.input-group.date input', $rootel).off();
        ...
        var formDataToPublicationData = function(data) {
            return {
                ...
                'department': data.ucamAuthor === 'yes' ? $.trim(data.department) : undefined,
                ...
                'acceptanceDate': (function() {
                    ...
                    return dateObj ? Date.UTC(dateObj.getFullYear(), dateObj.getMonth(), dateObj.getDate()) : undefined;
                }()),
                'funders': data.hasExternalFunders === 'no' ? [] : (function() {
                    // Ensure funders is an array, remove 'other' from the array if it's present
                    var funders = _.without([].concat(data.funders), 'other');
                ...
                'useCambridgeAddendum': data['useCambridgeAddendum'] === 'on'
            };
        };

        /**
         * Map a publication so that it can be pushed into the form
         *
        ...
        var publicationDataToFormData = function(publication) {
            ...
            return {
                ...
                'acceptanceDate': !publication.acceptanceDate ? '' : (function() {
                ...
                'ucamAuthor': publication.department ? 'yes' : 'no',
        ...
        var extendValidator = function() {
            ...
            // Requires otherFunders to have a value when the Other funder is checked
        ...
        var addBinding = function() {
            ...
            $rootel.on('change', '[name="ucamAuthor"]', function() {
                ...
                var $fields = $('[name="department"], [name="institution"]', $rootel).val('');
                // Toggle between the two fields, removing any active error states.
                $fields.parents('.form-group').toggle().removeClass('has-error').find('.oae-error').remove();
            });
        ...
        var initForm = function() {
            ...
            renderForm(getMinimumFormTemplateData(templateData));
