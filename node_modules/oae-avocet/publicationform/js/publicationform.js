    ...
    return function(uid, showSettings, widgetData) {
        ...
        var formDataToPublicationData = function(data) {
            return {
                ...
                'department': data.ucamAuthor === 'yes' ? $.trim(data.department) : null,
                ...
                'useCambridgeAddendum': data['useCambridgeAddendum'] === 'yes'
            };
        };
        ...
        var publicationDataToFormData = function(publication) {
            ...
            return {
                ...
                'useCambridgeAddendum': publication.useCambridgeAddendum !== 'false' ? 'yes' : 'no',
                'terms': true
            };
        };
