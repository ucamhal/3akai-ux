...
define(['jquery', 'underscore', 'oae.core', 'jquery.typeahead', 'bootstrap.datepicker', 'globalize'], function($, _, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var initFormValidation = function() {
            ...
            $('#oa-publicationform-input-other-funders', $rootel).on('change', function() {
        ...
        var initForm = function() {
            ...
            $rootel.on('change', 'input[name=funders][value=other]', function() {
                if ($(this).is(':checked')) {
                    $('#oa-publicationform-input-other-funders', $rootel).show().focus();
                } else {
                    $('#oa-publicationform-input-other-funders', $rootel).hide();
                }
            });
