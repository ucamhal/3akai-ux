...
FUNDERS = Funders
FUNDERS_OF_THIS_RESEARCH = Funder(s) of this research
I_ACCEPT_THE_TERMS_AND_CONDITIONS_OF_THE_UNIVERSITY_OF_CAMBRIDGE_REPOSITORY = I accept the <button type="button" class="oa-inline-btn-link oa-trigger-terms btn btn-link">Terms &amp; Conditions</button> of the University of Cambridge Repository.
I_AM_INTERESTED_IN_USING_THE_CAMBRIDGE_SCHOLARS_ADDENDUM = I'm interested in using the Cambridge Scholars' Addendum.
JOURNAL = Journal
MRC = MRC
