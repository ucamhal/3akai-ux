                ...
                <div class="row">
                    <div class="col-xs-6">
                        <a class="oa-btn-uni" href="http://www.cam.ac.uk/" target="_blank" title="__MSG__UNIVERSITY_OF_CAMBRIDGE_HOME__">
                            <img src="/avocet/images/main-logo.png" alt="__MSG__UNIVERSITY_OF_CAMBRIDGE__" width="178" height="38">
                        </a>
                    </div>
...
<div id="oa-avocetheader-authentication-template"><!--
    ...
    {else}
        <button id="oa-avocetheader-logout" class="btn oa-btn-auth oa-btn-secondary">__MSG__SIGN_OUT__</button>
    {/if}
