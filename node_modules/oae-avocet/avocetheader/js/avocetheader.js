 ...
 */
 ...
 define(['jquery', 'oae.core'], function($, oae) {
    ...
    var Nav = function Nav(href, name, children) {
        ...
        // Define Nav's methods (don't mention the p word)
        /**
         * @param {Array} [dest] An optional Array to append the descendants to
         * @return an Array containing this Nav, child Navs, their children etc
         */
        ...
        /** @return the nearest descendant Nav with a defined href */
        ...
        /** @return an Array of this Nav's immediate children Navs */
         ...
         * @return whether the Nav is active for the specified URL path
         */
        ...
        /** @return true if this Nav has an active child Nav */
         ...
         *
         * @param {string} [urlPath] The path to test for the Nav being active against. Defaults to the current window.location.pathname if not provided.
         * @return The depth of the deepest Nav which is active, or -1 if no Navs are active.
         */
    ...
    _.extend(Nav, {
         ...
         * @return an Array of Navs from a (parsed) JSON Array of links
         */
         ...
         * @return a root Nav containing Navs from the links Array.
         */
