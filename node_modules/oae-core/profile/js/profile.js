...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings, widgetData) {
        ...
        var setupPublicationsInfiniteScroll = function() {
            ...
            var options = {
                //scrollContainer: $publicationsList
            };

            $publicationsList.infiniteScroll(url, params, renderer, options);
        };
         ...
         * to the end as they get grouped by year into a sublist for each
         * year.
         *
